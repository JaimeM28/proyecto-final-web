...
export const DashboardProvider = () => {
  ...
  const stats = [
    { label: 'Solicitudes pendientes', value: '3', icon: Clock, color: 'text-orange-600', bg: 'bg-orange-100' },
    { label: 'Trabajos activos', value: '2', icon: Briefcase, color: 'text-blue-600', bg: 'bg-blue-100' },
    { label: 'Completados este mes', value: '12', icon: CheckCircle, color: 'text-green-600', bg: 'bg-green-100' },
    { label: 'Ingresos estimados', value: '$8,400', icon: DollarSign, color: 'text-primary', bg: 'bg-blue-50' },
  ];

  const pendingRequests = [
    { client: 'Ana Martínez', service: 'Instalación de lavabo', location: 'Polanco', time: 'Hace 2 horas' },
    { client: 'Roberto Silva', service: 'Reparación de tubería', location: 'Roma Norte', time: 'Hace 4 horas' },
    { client: 'Laura Gómez', service: 'Cambio de llaves', location: 'Condesa', time: 'Hace 1 día' },
  ];

  const activeJobs = [
    { client: 'Carlos Ramírez', service: 'Instalación de calentador', status: 'En progreso', date: '15 May' },
    { client: 'Patricia López', service: 'Reparación de fuga', status: 'Programado', date: '16 May' },
  ];
        ...
        <header className="bg-white border-b border-border px-4 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="ml-12 lg:ml-0">
              ...
              <p className="text-sm text-muted-foreground">Jueves, 15 de Mayo de 2026</p>
            </div>
                  ...
                  <div key={idx} className="p-6 hover:bg-muted/50 transition-colors">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">📍 {req.location}</p>
                      </div>
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-semibold text-green-600">$8,400</p>
                  </div>
                </div>
              </div>
            </div>
