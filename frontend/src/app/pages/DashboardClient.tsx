...
export const DashboardClient = () => {
  ...
  const recentRequests = [
    { service: 'Reparación de fuga', provider: 'Juan Pérez', status: 'Completado', date: '10 May 2026' },
    { service: 'Instalación eléctrica', provider: 'María García', status: 'En progreso', date: '14 May 2026' },
  ];
          ...
          <Card className="p-6 mb-8">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <Input placeholder="Buscar profesionales o servicios..." className="pl-10" />
              </div>
                ...
                <Card key={idx} className="overflow-hidden hover:shadow-md transition-shadow">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center gap-1 mb-3">
                      ...
                      <span className="text-sm text-muted-foreground">({pro.reviews} reseñas)</span>
                    </div>
                  ...
                  <div key={idx} className="p-6 hover:bg-muted/50 transition-colors">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{req.provider}</p>
                      </div>
